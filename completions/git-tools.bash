...
_shtab_git_commit_stats__h_nargs=0
_shtab_git_commit_stats___help_nargs=0
_shtab_git_commit_stats__V_nargs=0
_shtab_git_commit_stats___version_nargs=0
...
_shtab_git_commit_stats() {
  ...
  local prefix=_shtab_git_commit_stats
  local word_index=0
...
_shtab_git_pack_stats() {
  ...
  local prefix=_shtab_git_pack_stats
  local word_index=0
  local pos_only=0 # "--" delimeter not encountered yet
  _set_parser_defaults
  word_index=1
...
_shtab_git_repo_manager___help_nargs=0
_shtab_git_repo_manager__V_nargs=0
...
_shtab_git_repo_manager() {
  ...
  local prefix=_shtab_git_repo_manager
  local word_index=0
  local pos_only=0 # "--" delimeter not encountered yet
  _set_parser_defaults
  word_index=1
...
complete -o filenames -F _shtab_git_repo_manager git-repo-manager

_shtab_git_stats_subparsers=('commit' 'pack')
...
_shtab_git_stats_pos_0_choices=('commit' 'pack')

_shtab_git_stats_pos_0_nargs=A...
_shtab_git_stats__h_nargs=0
_shtab_git_stats___help_nargs=0
_shtab_git_stats__V_nargs=0
_shtab_git_stats___version_nargs=0
_shtab_git_stats_commit__h_nargs=0
_shtab_git_stats_commit___help_nargs=0
_shtab_git_stats_pack__h_nargs=0
_shtab_git_stats_pack___help_nargs=0
_shtab_git_stats_pack__H_nargs=0
...
complete -o filenames -F _shtab_git_stats git-stats
